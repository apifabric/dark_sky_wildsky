...
resourcename="darkskywildsky"  # lower case, only
resourcegroup="darkskywildsky_rg"
...
# git clone https://github.com/apilogicserver/darkskywildsky.git
# cd darkskywildsky
...
az group create --name darkskywildsky_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group darkskywildsky_rg --sku S1 --is-linux
az container create --resource-group darkskywildsky_rg --name darkskywildsky --image apilogicserver/darkskywildsky:latest --dns-name-label darkskywildsky --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//darkskywildsky.westus.azurecontainer.io:5656'
